...
struct WhisperEncoderLayerWeight {
    ...
    WhisperEncoderLayerWeight() = default;
    WhisperEncoderLayerWeight(const size_t head_num,
    ...
    ~WhisperEncoderLayerWeight();
    WhisperEncoderLayerWeight(const WhisperEncoderLayerWeight& other);
    WhisperEncoderLayerWeight& operator=(const WhisperEncoderLayerWeight& other);
