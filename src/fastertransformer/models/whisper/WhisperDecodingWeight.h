...
template<typename T>
struct WhisperDecodingWeight {

    WhisperDecodingWeight() = default;
    WhisperDecodingWeight(const size_t                head_num,
                       ...
                       const bool                  whisper_with_bias_para          = true,
                       const bool                  mwhisper_para                   = false,
    ...
    ~WhisperDecodingWeight();
    WhisperDecodingWeight(const WhisperDecodingWeight& other);
    WhisperDecodingWeight& operator=(const WhisperDecodingWeight& other);

    LayerNormWeight<T>                      pre_decoder_layernorm;
    std::vector<WhisperDecoderLayerWeight<T>*> decoder_layer_weights;
    ...
    void setWhisperStructureDiff(bool                  whisper_with_bias_para,
                              bool                  mwhisper_para,
