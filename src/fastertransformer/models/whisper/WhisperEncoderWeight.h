...
struct WhisperEncoderWeight {
    ...
    WhisperEncoderWeight() = default;
    WhisperEncoderWeight(const size_t                head_num,
    ...
    ~WhisperEncoderWeight();
    WhisperEncoderWeight(const WhisperEncoderWeight& other);
    WhisperEncoderWeight& operator=(const WhisperEncoderWeight& other);

    LayerNormWeight<T>                      pre_transformer_layernorm_weights;
    std::vector<WhisperEncoderLayerWeight<T>*> whisper_encoder_layer_weights;
