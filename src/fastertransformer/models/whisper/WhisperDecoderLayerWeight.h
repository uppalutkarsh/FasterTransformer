...
struct WhisperDecoderLayerWeight {
    ...
    WhisperDecoderLayerWeight() = default;
    WhisperDecoderLayerWeight(const size_t head_num,
                           ...
                           const bool   whisper_with_bias       = true,
                           const bool   use_gated_activation = false);
    ~WhisperDecoderLayerWeight();
    WhisperDecoderLayerWeight(const WhisperDecoderLayerWeight& other);
    WhisperDecoderLayerWeight& operator=(const WhisperDecoderLayerWeight& other);
    ...
    bool               whisper_with_bias_;
    bool               use_gated_activation_;

    void loadModel(std::string dir_path, FtCudaDataType model_file_type);

    void setWhisperWithBias(bool whisper_with_bias_para, bool use_gated_activation_para);
