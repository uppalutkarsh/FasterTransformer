...
#include "src/fastertransformer/th_op/whisper/WhisperEncoderOp.h"

namespace th = torch;
namespace torch_ext {

FasterTransformerWhisperEncoder::FasterTransformerWhisperEncoder(th::Tensor  attr_output_layernorm_gamma,
                                                           th::Tensor  q_kernel,
                                                           th::Tensor  k_kernel,
                                                           th::Tensor  v_kernel,
            ...
            post_transformer_layernorm_beta}
{
    ...
    switch (_st) {
        case at::ScalarType::Float:
            ft_whisper_encoder = new FTWhisperEncoder<float>(head_num,
                                                       head_size,
                                                       inter_size,
                                                       d_model,
                                                       layer_num,
        ...
        case at::ScalarType::Half:
            ft_whisper_encoder = new FTWhisperEncoder<half>(head_num,
                                                      head_size,
                                                      inter_size,
                                                      d_model,
                                                      layer_num,
        ...
        case at::ScalarType::BFloat16:
            ft_whisper_encoder = new FTWhisperEncoder<__nv_bfloat16>(head_num,
                                                               head_size,
                                                               inter_size,
                                                               d_model,
                                                               layer_num,
...
FasterTransformerWhisperEncoder::~FasterTransformerWhisperEncoder()
{
    delete ft_whisper_encoder;
}

th::Tensor FasterTransformerWhisperEncoder::forward(th::optional<th::Tensor> input_ids,
                                                 ...
                                                 th::optional<th::Tensor> inputs_embeds)
{
    ...
    ft_whisper_encoder->forward(batch_size, seq_len, input_ids, sequence_lengths, inputs_embeds, output, _remove_padding);
    return output;
}
...
static auto fasterTransformerWhisperEncoderTHS =
    ...
    torch::jit::class_<torch_ext::FasterTransformerWhisperEncoder>("FasterTransformer", "WhisperEncoder")
        ...
        .def(torch::jit::init<th::Tensor,
                              ...
                              std::string,
                              std::string>())
        .def("forward", &torch_ext::FasterTransformerWhisperEncoder::forward);
