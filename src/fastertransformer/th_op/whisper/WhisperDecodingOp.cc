...
#include "src/fastertransformer/th_op/whisper/WhisperDecodingOp.h"

namespace th = torch;

namespace torch_ext {

FasterTransformerWhisperDecoding::FasterTransformerWhisperDecoding(int64_t     head_num,
            ...
            embedding_bias}
{
    ...
    switch (_st) {
        case at::ScalarType::Float:
            ftdecoding = new torch_ext::FTWhisperDecoding<float>(head_num,
                                                              size_per_head,
                                                              inter_size,
                                                              mem_d_model,
                                                              d_model,
        ...
        case at::ScalarType::Half:
            ftdecoding = new torch_ext::FTWhisperDecoding<half>(head_num,
                                                             size_per_head,
                                                             inter_size,
                                                             mem_d_model,
                                                             d_model,
        ...
        case at::ScalarType::BFloat16:
            ftdecoding =
                new torch_ext::FTWhisperDecoding<__nv_bfloat16>(head_num,
                                                             size_per_head,
                                                             inter_size,
                                                             mem_d_model,
                                                             d_model,
...
FasterTransformerWhisperDecoding::~FasterTransformerWhisperDecoding()
{
    delete ftdecoding;
}

std::vector<th::Tensor> FasterTransformerWhisperDecoding::forward(th::optional<int64_t> beam_width,
                                                               int64_t               max_seq_len,
...
static auto fasterTransformerWhisperDecodingTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::FasterTransformerWhisperDecoding>("FasterTransformerWhisperDecoding")
#else
    torch::jit::class_<torch_ext::FasterTransformerWhisperDecoding>("FasterTransformer", "WhisperDecoding")
#endif
